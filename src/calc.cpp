...
int main() {
    ...
    //     }
        std::vector<Token> TokenVector;
        TokenVector.push_back(Token(TokenType::variable, "y", 1, 1));
        TokenVector.push_back(Token(TokenType::equals, "=", 1, 1));
        TokenVector.push_back(Token(TokenType::variable, "x", 1, 1));
        TokenVector.push_back(Token(TokenType::equals, "=", 1, 1));
        TokenVector.push_back(Token(TokenType::leftParenthesis, "(", 1, 1));
        TokenVector.push_back(Token(TokenType::number, "1", 1, 1, 1));
        TokenVector.push_back(Token(TokenType::equality, "==", 1, 1));
        TokenVector.push_back(Token(TokenType::number, "2", 1, 1, 2));
        TokenVector.push_back(Token(TokenType::rightParenthesis, ")", 1, 1));
        TokenVector.push_back(Token(TokenType::inclusive_or, "|", 1, 1));
        TokenVector.push_back(Token(TokenType::leftParenthesis, "(", 1, 1));
        TokenVector.push_back(Token(TokenType::number, "1", 1, 1,1));
        TokenVector.push_back(Token(TokenType::plus, "+", 1, 1));
        TokenVector.push_back(Token(TokenType::number, "1", 1, 1,1));
        TokenVector.push_back(Token(TokenType::rightParenthesis, ")", 1, 1));
        TokenVector.push_back(Token(TokenType::bigger_equal, ">=", 1, 1));
        TokenVector.push_back(Token(TokenType::number, "2", 1, 1,2));
        TokenVector.push_back(Token(TokenType::end, "", 1, 1));
